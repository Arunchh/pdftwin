...
const EN_LANDINGS: SeoLanding[] = [
  ...
  },
  {
    ...
    locale: "en",
    toolId: "pdf-to-jpg",
    title: "PDF to JPG Free — Export Pages as Images | PDFTwin",
    metaDescription:
      "Convert PDF pages to JPG or PNG free in your browser. Multi-page ZIP download. No watermark, files stay on your device.",
    h1: "PDF to JPG free online",
    intro:
      "Export PDF pages as images for slides, social posts, and email. PDFTwin renders with PDF.js in your browser — no server upload.",
    benefits: ["JPG or PNG output", "Multi-page ZIP download", "Processed locally", "Free with no watermark"],
    steps: [
      { title: "Upload PDF", body: "Select the PDF to export." },
      { title: "Choose format", body: "Pick JPG or PNG for each page." },
      { title: "Download", body: "Save images or a ZIP of all pages." },
    ],
    faq: [{ question: "Are pages uploaded?", answer: "No. PDF to JPG runs in your browser with PDF.js." }],
    ctaLabel: "Convert to JPG now",
    relatedSlugs: ["images-to-pdf-free", "compress-pdf-free"],
  },
  {
    slug: "pdf-to-text-free",
    locale: "en",
    toolId: "pdf-to-text",
    title: "PDF to Text Free — Extract Selectable Text | PDFTwin",
    metaDescription:
      "Extract text from PDF to .txt free in your browser. Uses the PDF text layer — for scans use OCR. No watermark.",
    h1: "PDF to text free online",
    intro:
      "Pull editable text from digital PDFs into a .txt file. Processing stays on your device — ideal for quotes, clauses, and data entry.",
    benefits: ["Text layer extraction", "Runs in browser", "Free unlimited use", "Scans → use OCR tool"],
    steps: [
      { title: "Upload PDF", body: "Select a PDF with selectable text." },
      { title: "Extract", body: "PDFTwin reads the text layer locally." },
      { title: "Download", body: "Save the .txt file." },
    ],
    faq: [{ question: "Will this work on scanned PDFs?", answer: "No. Use the OCR tool for scanned pages and photos." }],
    ctaLabel: "Extract text now",
    relatedSlugs: ["ocr-pdf-online", "pdf-to-word-free"],
  },
  {
    slug: "convert-images-online",
    locale: "en",
    toolId: "image-convert",
    title: "Convert Images Online Free — PNG, JPG, WebP | PDFTwin",
    metaDescription:
      "Convert PNG, JPG, GIF, BMP, or TIFF to WebP, PNG, or JPEG. Free up to 50 MB, secure processing, no watermark.",
    h1: "Convert images online free",
    intro:
      "Standardize image formats for web, email, and decks. Upload once and download in the format your workflow needs.",
    benefits: ["PNG, JPG, WebP, GIF, BMP, TIFF in", "WebP, PNG, JPEG out", "Up to 50 MB free", "No watermark"],
    steps: [
      { title: "Upload image", body: "Select your source file." },
      { title: "Pick output", body: "Choose WebP, PNG, or JPEG." },
      { title: "Download", body: "Save the converted image." },
    ],
    faq: [],
    ctaLabel: "Convert image now",
    relatedSlugs: ["images-to-pdf-free", "resize-images-online"],
  },
  {
    slug: "resize-images-online",
    locale: "en",
    toolId: "image-resize",
    title: "Resize Images Online Free — Compress for Web & Email | PDFTwin",
    metaDescription:
      "Resize and compress images for email and web. Free up to 50 MB. Secure server processing, discarded immediately.",
    h1: "Resize images online free",
    intro:
      "Shrink photos and screenshots for faster email delivery and lighter slide decks without a desktop editor.",
    benefits: ["Custom width/height", "Quality presets", "50 MB free per file", "No watermark"],
    steps: [
      { title: "Upload", body: "Select the image." },
      { title: "Set size", body: "Enter dimensions or pick a preset." },
      { title: "Download", body: "Save the resized file." },
    ],
    faq: [],
    ctaLabel: "Resize image now",
    relatedSlugs: ["convert-images-online", "compress-pdf-free"],
  },
  {
    slug: "watermark-pdf-free",
    locale: "en",
    toolId: "watermark-pdf",
    title: "Watermark PDF Free — Draft or Confidential | PDFTwin",
    metaDescription:
      "Add text or image watermarks to PDF files. Free up to 50 MB, secure processing, no watermark on your brand output.",
    h1: "Watermark PDF free online",
    intro:
      "Mark drafts, confidential copies, and internal reviews with a text or image watermark across every page.",
    benefits: ["Text or image watermark", "Adjust opacity and placement", "50 MB free", "No extra logo watermark from us"],
    steps: [
      { title: "Upload PDF", body: "Select the document." },
      { title: "Add watermark", body: "Enter text or upload an image." },
      { title: "Download", body: "Save the watermarked PDF." },
    ],
    faq: [],
    ctaLabel: "Watermark PDF now",
    relatedSlugs: ["protect-pdf-password", "compress-pdf-free"],
  },
  {
    slug: "protect-pdf-password",
    locale: "en",
    toolId: "lock-unlock",
    title: "Protect PDF with Password Free — Lock & Unlock | PDFTwin",
    metaDescription:
      "Add password protection to PDF or remove restrictions securely. Free up to 50 MB, files discarded after processing.",
    h1: "Protect PDF with password free",
    intro:
      "Lock confidential PDFs with a password or unlock files you own. Secure server processing — files never stored.",
    benefits: ["Encrypt with password", "Unlock PDFs you own", "50 MB free", "No watermark"],
    steps: [
      { title: "Upload PDF", body: "Select the file to lock or unlock." },
      { title: "Set password", body: "Enter open password or unlock key." },
      { title: "Download", body: "Save the protected or unlocked PDF." },
    ],
    faq: [{ question: "Can PDFTwin recover a lost password?", answer: "No. We cannot recover passwords you forget." }],
    ctaLabel: "Protect PDF now",
    relatedSlugs: ["watermark-pdf-free", "sign-pdf-online"],
  },
];
...
const ES_LANDINGS: SeoLanding[] = [
  ...
  },
  {
    ...
    locale: "es",
    toolId: "pdf-to-jpg",
    title: "PDF a JPG Gratis — Exportar Páginas | PDFTwin",
    metaDescription: "Convierte PDF a JPG o PNG gratis en el navegador. ZIP multipágina. Sin marca de agua.",
    h1: "PDF a JPG gratis online",
    intro: "Exporta páginas PDF como imágenes para diapositivas y email. Procesado localmente con PDF.js.",
    benefits: ["JPG o PNG", "ZIP multipágina", "En el navegador", "Sin marca de agua"],
    steps: [
      { title: "Sube PDF", body: "Selecciona el archivo." },
      { title: "Formato", body: "Elige JPG o PNG." },
      { title: "Descarga", body: "Guarda imágenes o ZIP." },
    ],
    faq: [],
    ctaLabel: "Convertir a JPG",
    relatedSlugs: ["imagenes-a-pdf", "comprimir-pdf"],
  },
  {
    slug: "pdf-a-texto",
    locale: "es",
    toolId: "pdf-to-text",
    title: "PDF a Texto Gratis — Extraer Texto | PDFTwin",
    metaDescription: "Extrae texto de PDF a .txt gratis en el navegador. Para escaneos usa OCR.",
    h1: "PDF a texto gratis online",
    intro: "Obtén texto editable de PDFs digitales. Procesado en tu dispositivo.",
    benefits: ["Capa de texto", "En navegador", "Uso ilimitado", "Escaneos → OCR"],
    steps: [
      { title: "Sube PDF", body: "PDF con texto seleccionable." },
      { title: "Extrae", body: "Lee la capa de texto." },
      { title: "Descarga", body: "Guarda el .txt." },
    ],
    faq: [],
    ctaLabel: "Extraer texto",
    relatedSlugs: ["ocr-pdf", "pdf-a-word"],
  },
  {
    slug: "convertir-imagenes",
    locale: "es",
    toolId: "image-convert",
    title: "Convertir Imágenes Online Gratis | PDFTwin",
    metaDescription: "Convierte PNG, JPG, GIF, BMP o TIFF a WebP, PNG o JPEG. Gratis hasta 50 MB.",
    h1: "Convertir imágenes online gratis",
    intro: "Estandariza formatos para web y email.",
    benefits: ["Varios formatos entrada", "WebP, PNG, JPEG salida", "50 MB gratis", "Sin marca de agua"],
    steps: [
      { title: "Sube imagen", body: "Selecciona archivo." },
      { title: "Salida", body: "Elige formato." },
      { title: "Descarga", body: "Guarda resultado." },
    ],
    faq: [],
    ctaLabel: "Convertir imagen",
    relatedSlugs: ["imagenes-a-pdf", "redimensionar-imagenes"],
  },
  {
    slug: "redimensionar-imagenes",
    locale: "es",
    toolId: "image-resize",
    title: "Redimensionar Imágenes Gratis | PDFTwin",
    metaDescription: "Redimensiona y comprime imágenes para email y web. Gratis hasta 50 MB.",
    h1: "Redimensionar imágenes gratis",
    intro: "Reduce fotos y capturas para adjuntos más ligeros.",
    benefits: ["Ancho/alto personalizado", "Presets de calidad", "50 MB gratis", "Sin marca de agua"],
    steps: [
      { title: "Sube", body: "Selecciona imagen." },
      { title: "Tamaño", body: "Introduce dimensiones." },
      { title: "Descarga", body: "Guarda archivo." },
    ],
    faq: [],
    ctaLabel: "Redimensionar",
    relatedSlugs: ["convertir-imagenes", "comprimir-pdf"],
  },
  {
    slug: "marca-agua-pdf",
    locale: "es",
    toolId: "watermark-pdf",
    title: "Marca de Agua PDF Gratis | PDFTwin",
    metaDescription: "Añade marca de agua de texto o imagen a PDF. Gratis hasta 50 MB.",
    h1: "Marca de agua PDF gratis",
    intro: "Marca borradores y copias confidenciales en todas las páginas.",
    benefits: ["Texto o imagen", "Opacidad ajustable", "50 MB gratis", "Sin logo nuestro en salida"],
    steps: [
      { title: "Sube PDF", body: "Selecciona documento." },
      { title: "Marca", body: "Texto o imagen." },
      { title: "Descarga", body: "Guarda PDF." },
    ],
    faq: [],
    ctaLabel: "Añadir marca de agua",
  ...
  },
  {
    ...
    locale: "es",
    toolId: "lock-unlock",
    title: "Proteger PDF con Contraseña Gratis | PDFTwin",
    metaDescription: "Añade contraseña a PDF o quita restricciones. Gratis hasta 50 MB.",
    h1: "Proteger PDF con contraseña gratis",
    intro: "Cifra PDF confidenciales o desbloquea archivos propios.",
    benefits: ["Cifrar con contraseña", "Desbloquear PDFs propios", "50 MB gratis", "Sin marca de agua"],
    steps: [
      { title: "Sube PDF", body: "Archivo a proteger." },
      { title: "Contraseña", body: "Introduce clave." },
      { title: "Descarga", body: "Guarda PDF." },
    ],
    faq: [],
    ctaLabel: "Proteger PDF",
    relatedSlugs: ["marca-agua-pdf", "firmar-pdf"],
  },
];
...
const FR_LANDINGS: SeoLanding[] = [
  ...
  },
  {
    ...
    locale: "fr",
    toolId: "pdf-to-jpg",
    title: "PDF vers JPG Gratuit | PDFTwin",
    metaDescription: "Convertissez PDF en JPG ou PNG gratuitement dans le navigateur.",
    h1: "PDF vers JPG gratuit",
    intro: "Exportez des pages PDF en images — traitement local.",
    benefits: ["JPG ou PNG", "ZIP multipage", "Local", "Sans filigrane"],
    steps: [
      { title: "PDF", body: "Téléversez." },
      { title: "Format", body: "JPG ou PNG." },
      { title: "Téléchargez", body: "Images ou ZIP." },
    ],
    faq: [],
    ctaLabel: "Convertir en JPG",
    relatedSlugs: ["images-en-pdf", "compresser-pdf"],
  },
  {
    slug: "pdf-vers-texte",
    locale: "fr",
    toolId: "pdf-to-text",
    title: "PDF vers Texte Gratuit | PDFTwin",
    metaDescription: "Extrayez le texte d'un PDF en .txt gratuitement dans le navigateur.",
    h1: "PDF vers texte gratuit",
    intro: "Texte éditable depuis PDF numériques — localement.",
    benefits: ["Couche texte", "Navigateur", "Illimité", "Scans → OCR"],
    steps: [
      { title: "PDF", body: "Fichier avec texte." },
      { title: "Extraire", body: "Couche texte." },
      { title: "TXT", body: "Téléchargez." },
    ],
    faq: [],
    ctaLabel: "Extraire le texte",
    relatedSlugs: ["ocr-pdf", "pdf-vers-word"],
  },
  {
    slug: "convertir-images",
    locale: "fr",
    toolId: "image-convert",
    title: "Convertir Images Gratuit | PDFTwin",
    metaDescription: "PNG, JPG, GIF, BMP, TIFF vers WebP, PNG ou JPEG. Gratuit jusqu'à 50 Mo.",
    h1: "Convertir images gratuit",
    intro: "Standardisez les formats pour le web.",
    benefits: ["Entrées multiples", "WebP, PNG, JPEG", "50 Mo gratuits", "Sans filigrane"],
    steps: [
      { title: "Image", body: "Téléversez." },
      { title: "Sortie", body: "Choisissez format." },
      { title: "Téléchargez", body: "Enregistrez." },
    ],
    faq: [],
    ctaLabel: "Convertir",
    relatedSlugs: ["images-en-pdf", "redimensionner-images"],
  },
  {
    slug: "redimensionner-images",
    locale: "fr",
    toolId: "image-resize",
    title: "Redimensionner Images Gratuit | PDFTwin",
    metaDescription: "Redimensionnez images pour e-mail et web. Gratuit jusqu'à 50 Mo.",
    h1: "Redimensionner images gratuit",
    intro: "Réduisez photos et captures pour pièces jointes.",
    benefits: ["Dimensions custom", "Presets", "50 Mo gratuits", "Sans filigrane"],
    steps: [
      { title: "Image", body: "Téléversez." },
      { title: "Taille", body: "Dimensions." },
      { title: "Téléchargez", body: "Enregistrez." },
    ],
    faq: [],
    ctaLabel: "Redimensionner",
    relatedSlugs: ["convertir-images", "compresser-pdf"],
  },
  {
    slug: "filigrane-pdf",
    locale: "fr",
    toolId: "watermark-pdf",
    title: "Filigrane PDF Gratuit | PDFTwin",
    metaDescription: "Ajoutez filigrane texte ou image. Gratuit jusqu'à 50 Mo.",
    h1: "Filigrane PDF gratuit",
    intro: "Marquez brouillons et copies confidentielles.",
    benefits: ["Texte ou image", "Opacité", "50 Mo gratuits", "Sans logo PDFTwin"],
    steps: [
      { title: "PDF", body: "Téléversez." },
      { title: "Filigrane", body: "Texte ou image." },
      { title: "Téléchargez", body: "Enregistrez." },
    ],
    faq: [],
    ctaLabel: "Filigrane",
    relatedSlugs: ["proteger-pdf", "compresser-pdf"],
  },
  {
    slug: "proteger-pdf",
    locale: "fr",
    toolId: "lock-unlock",
    title: "Protéger PDF par Mot de Passe | PDFTwin",
    metaDescription: "Verrouillez ou déverrouillez PDF. Gratuit jusqu'à 50 Mo.",
    h1: "Protéger PDF gratuit",
    intro: "Chiffrez documents ou retirez restrictions.",
    benefits: ["Mot de passe", "Déverrouillage", "50 Mo gratuits", "Sans filigrane"],
    steps: [
      { title: "PDF", body: "Téléversez." },
      { title: "Mot de passe", body: "Saisissez." },
      { title: "Téléchargez", body: "Enregistrez." },
    ],
    faq: [],
    ctaLabel: "Protéger",
    relatedSlugs: ["filigrane-pdf", "signer-pdf"],
  },
];
...
const NL_LANDINGS: SeoLanding[] = [
  ...
  },
  {
    ...
    locale: "nl",
    toolId: "pdf-to-jpg",
    title: "PDF naar JPG Gratis | PDFTwin",
    metaDescription: "Converteer PDF naar JPG of PNG gratis in de browser.",
    h1: "PDF naar JPG gratis",
    intro: "Exporteer PDF-pagina's als afbeeldingen — lokaal verwerkt.",
    benefits: ["JPG of PNG", "ZIP multipagina", "In browser", "Geen watermerk"],
    steps: [
      { title: "Upload PDF", body: "Kies bestand." },
      { title: "Formaat", body: "JPG of PNG." },
      { title: "Download", body: "Afbeeldingen of ZIP." },
    ],
    faq: [],
    ctaLabel: "Naar JPG",
    relatedSlugs: ["afbeeldingen-naar-pdf", "pdf-comprimeren"],
  },
  {
    slug: "pdf-naar-tekst",
    locale: "nl",
    toolId: "pdf-to-text",
    title: "PDF naar Tekst Gratis | PDFTwin",
    metaDescription: "Haal tekst uit PDF naar .txt gratis in de browser.",
    h1: "PDF naar tekst gratis",
    intro: "Bewerkbare tekst uit digitale PDF's — op uw apparaat.",
    benefits: ["Tekstlaag", "Browser", "Onbeperkt", "Scans → OCR"],
    steps: [
      { title: "Upload PDF", body: "PDF met tekst." },
      { title: "Extraheer", body: "Tekstlaag lezen." },
      { title: "Download", body: "Sla .txt op." },
    ],
    faq: [],
    ctaLabel: "Tekst extraheren",
    relatedSlugs: ["pdf-ocr", "pdf-naar-word"],
  },
  {
    slug: "afbeeldingen-converteren",
    locale: "nl",
    toolId: "image-convert",
    title: "Afbeeldingen Converteren Gratis | PDFTwin",
    metaDescription: "PNG, JPG, GIF, BMP, TIFF naar WebP, PNG of JPEG. Gratis tot 50 MB.",
    h1: "Afbeeldingen converteren gratis",
    intro: "Standaardiseer formaten voor web en e-mail.",
    benefits: ["Meerdere invoerformaten", "WebP, PNG, JPEG", "50 MB gratis", "Geen watermerk"],
    steps: [
      { title: "Upload", body: "Kies afbeelding." },
      { title: "Output", body: "Kies formaat." },
      { title: "Download", body: "Bewaar bestand." },
    ],
    faq: [],
    ctaLabel: "Converteren",
    relatedSlugs: ["afbeeldingen-naar-pdf", "afbeeldingen-formaat"],
  },
  {
    slug: "afbeeldingen-formaat",
    locale: "nl",
    toolId: "image-resize",
    title: "Afbeeldingen Formaat Wijzigen Gratis | PDFTwin",
    metaDescription: "Verklein afbeeldingen voor e-mail en web. Gratis tot 50 MB.",
    h1: "Afbeeldingen formaat wijzigen",
    intro: "Maak foto's lichter voor bijlagen.",
    benefits: ["Aangepaste afmetingen", "Kwaliteitspresets", "50 MB gratis", "Geen watermerk"],
    steps: [
      { title: "Upload", body: "Kies afbeelding." },
      { title: "Formaat", body: "Afmetingen instellen." },
      { title: "Download", body: "Opslaan." },
    ],
    faq: [],
    ctaLabel: "Formaat wijzigen",
    relatedSlugs: ["afbeeldingen-converteren", "pdf-comprimeren"],
  },
  {
    slug: "pdf-watermerk",
    locale: "nl",
    toolId: "watermark-pdf",
    title: "PDF Watermerk Gratis | PDFTwin",
    metaDescription: "Voeg tekst- of afbeeldingswatermerk toe. Gratis tot 50 MB.",
    h1: "PDF watermerk gratis",
    intro: "Markeer concepten en vertrouwelijke kopieën.",
    benefits: ["Tekst of afbeelding", "Dekking instelbaar", "50 MB gratis", "Geen PDFTwin-logo"],
    steps: [
      { title: "Upload PDF", body: "Kies document." },
      { title: "Watermerk", body: "Tekst of afbeelding." },
      { title: "Download", body: "Opslaan." },
    ],
    faq: [],
    ctaLabel: "Watermerk toevoegen",
    relatedSlugs: ["pdf-beveiligen", "pdf-comprimeren"],
  },
  {
    slug: "pdf-beveiligen",
    locale: "nl",
    toolId: "lock-unlock",
    title: "PDF Beveiligen met Wachtwoord | PDFTwin",
    metaDescription: "Vergrendel of ontgrendel PDF met wachtwoord. Gratis tot 50 MB.",
    h1: "PDF beveiligen gratis",
    intro: "Versleutel vertrouwelijke PDF's of verwijder beperkingen.",
    benefits: ["Wachtwoord", "Ontgrendelen", "50 MB gratis", "Geen watermerk"],
    steps: [
      { title: "Upload PDF", body: "Kies bestand." },
      { title: "Wachtwoord", body: "Invoeren." },
      { title: "Download", body: "Opslaan." },
    ],
    faq: [],
    ctaLabel: "PDF beveiligen",
    relatedSlugs: ["pdf-watermerk", "pdf-ondertekenen"],
  },
];
