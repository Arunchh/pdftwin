...
export const pt: Messages = {
  meta: {
    ...
    toolsIndexTitle: "Todas as ferramentas PDF — Comparar, juntar, converter | PDFTwin",
    toolsIndexDescription:
      "Explore as 18 ferramentas PDFTwin: comparar PDFs, juntar, dividir, converter para Word, OCR, marca d'água, assinar, comprimir e mais — grátis no navegador.",
  ...
  nav: {
    ...
    main: "Principal",
    browseToolIndex: "Ver índice completo de ferramentas",
  },
  hero: {
  ...
  toolsIndex: {
    heading: "Todas as ferramentas PDFTwin",
    subheading:
      "Cada ferramenta de conversão e PDF empresarial num só lugar — agrupadas como no menu de navegação.",
    breadcrumb: "Todas as ferramentas",
    compareCta: "Comparar PDFs agora",
    homeCta: "Voltar ao início",
  },
  compare: {
    setupTitle: "Escolha dois PDFs para comparar",
    setupDescription:
      "Adicione o PDF esquerdo e direito no painel à direita e clique em Comparar para abrir o visualizador lado a lado.",
    setupAwaitingFiles: "Adicione ambos os PDFs pelos espaços de upload à direita e clique em Comparar.",
    setupReadyHint: "Ambos os PDFs estão prontos — clique em Comparar no painel à direita.",
    fileTrayTitle: "Seus documentos",
    fileTrayDescription: "Adicione um PDF à esquerda e outro à direita e compare-os lado a lado.",
    leftSlotLabel: "Esquerdo",
    rightSlotLabel: "Direito",
    leftSlotPlaceholder: "Solte seu PDF esquerdo aqui",
    rightSlotPlaceholder: "Solte seu PDF direito aqui",
    browsePdf: "Procurar PDF",
    slotEmptyHint: "Apenas PDF · arrastar e soltar ou procurar",
