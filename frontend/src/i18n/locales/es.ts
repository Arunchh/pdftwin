...
export const es: Messages = {
  ...
  home: {
    ...
    complementary: {
      ...
      subheading:
        "Busca por la tarea: convertir un archivo, reorganizar las páginas o protegerlo antes de enviarlo.",
      groups: {
        export: {
          title: "Exportar desde PDF",
          description: "¿Necesitas un Word, una hoja de cálculo, imágenes o texto seleccionable a partir de un PDF?",
        },
        create: {
          title: "Crear un PDF",
          description: "Parte de un documento Word o de fotos — o convierte y redimensiona imágenes antes de compartirlas.",
        },
        pages: {
          title: "Reorganizar las páginas",
          description: "Divide un archivo, extrae páginas, elimina extras, rota o combina varios PDF.",
        },
        finish: {
          title: "Terminar y proteger",
          description: "Comprime para el correo, marca un borrador, firma o bloquea el archivo.",
        },
      },
    },
  },
  ...
  compare: {
    ...
    setupDescription:
      "Añade tu PDF izquierdo y derecho en el panel de la derecha y haz clic en Comparar para abrir el visor lado a lado.",
    setupAwaitingFiles: "Añade ambos PDFs con los espacios de carga de la derecha y haz clic en Comparar.",
    setupReadyHint: "Ambos PDFs están listos — haz clic en Comparar en el panel de la derecha.",
    fileTrayTitle: "Tus documentos",
    fileTrayDescription: "Añade un PDF izquierdo y otro derecho, luego compáralos lado a lado.",
    leftSlotLabel: "Izquierdo",
    rightSlotLabel: "Derecho",
    leftSlotPlaceholder: "Suelta aquí tu PDF izquierdo",
    rightSlotPlaceholder: "Suelta aquí tu PDF derecho",
    browsePdf: "Buscar PDF",
    slotEmptyHint: "Solo PDF · arrastra y suelta o busca",
    ...
    preparingViewer: "Preparando el visor…",
    pages: "páginas",
    privacyHint:
