...
export const fr: Messages = {
  ...
  home: {
    ...
    complementary: {
      ...
      subheading:
        "Parcourez selon la tâche — convertir un fichier, réorganiser les pages, ou le verrouiller avant l'envoi.",
      groups: {
        export: {
          title: "Exporter depuis un PDF",
          description: "Besoin d'un fichier Word, d'un tableur, d'images ou de texte sélectionnable à partir d'un PDF ?",
        },
        create: {
          title: "Créer un PDF",
          description: "Partez d'un document Word ou de photos — ou convertissez et redimensionnez les images avant de les partager.",
        },
        pages: {
          title: "Réorganiser les pages",
          description: "Divisez un fichier, extrayez des pages, supprimez le superflu, pivotez ou fusionnez plusieurs PDF.",
        },
        finish: {
          title: "Finaliser et protéger",
          description: "Compressez pour l'e-mail, apposez un filigrane, signez ou verrouillez le fichier.",
        },
      },
    },
  },
  ...
  compare: {
    ...
    setupDescription:
      "Ajoutez votre PDF gauche et droit dans le panneau de droite, puis cliquez sur Comparer pour ouvrir le visualiseur côte à côte.",
    setupAwaitingFiles: "Ajoutez les deux PDF via les zones de dépôt à droite, puis cliquez sur Comparer.",
    setupReadyHint: "Les deux PDF sont prêts — cliquez sur Comparer dans le panneau de droite.",
    fileTrayTitle: "Vos documents",
    fileTrayDescription: "Ajoutez un PDF gauche et un PDF droit, puis comparez-les côte à côte.",
    leftSlotLabel: "Gauche",
    rightSlotLabel: "Droite",
    leftSlotPlaceholder: "Déposez votre PDF gauche ici",
    rightSlotPlaceholder: "Déposez votre PDF droit ici",
    browsePdf: "Parcourir",
  ...
  waitlist: {
    ariaLabel: "Annonce de lancement",
    badge: "Bientôt disponible",
    headline: "PDFTwin arrive bientôt — soyez parmi les premiers",
    subtext: "Rejoignez la liste d'attente pour un accès anticipé et des offres exclusives au lancement.",
    nameLabel: "Votre nom",
    ...
    success: "Vous êtes inscrit ! Nous vous écrirons au lancement.",
    alreadyJoined: "Vous êtes déjà sur la liste d'attente — nous vous contacterons bientôt.",
