...
export const nl: Messages = {
  ...
  compare: {
    ...
    setupDescription:
      "Voeg je linker- en rechter-PDF toe in het paneel rechts en klik op Vergelijken om de viewer naast elkaar te openen.",
    setupAwaitingFiles: "Voeg beide PDF's toe via de uploadvakken rechts en klik op Vergelijken.",
    setupReadyHint: "Beide PDF's zijn klaar — klik op Vergelijken in het paneel rechts.",
    fileTrayTitle: "Je documenten",
    fileTrayDescription: "Voeg een linker- en rechter-PDF toe en vergelijk ze naast elkaar.",
    leftSlotLabel: "Links",
    rightSlotLabel: "Rechts",
    leftSlotPlaceholder: "Sleep je linker PDF hierheen",
    rightSlotPlaceholder: "Sleep je rechter PDF hierheen",
